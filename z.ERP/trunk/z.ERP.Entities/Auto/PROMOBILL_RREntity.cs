...
{
    [DbTable("PROMOBILL_RR", "随机立减活动定义单")]
    public partial class PROMOBILL_RREntity : TableEntityBase
    {
        public PROMOBILL_RREntity()
        {
        }

        public PROMOBILL_RREntity(string id)
        {
            BILLID = id;
        }
        /// <summary>
