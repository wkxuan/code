...
namespace zlog4net.Util.TypeConverters
{
	/// <summary>
	...
	public sealed class ConverterRegistry
	{
		...
		static ConverterRegistry()
		{
			...
			AddConverter(typeof(zlog4net.Layout.PatternLayout), typeof(PatternLayoutConverter));
			AddConverter(typeof(zlog4net.Util.PatternString), typeof(PatternStringConverter));
