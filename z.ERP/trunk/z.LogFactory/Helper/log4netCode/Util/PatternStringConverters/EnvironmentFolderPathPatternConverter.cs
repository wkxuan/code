...
namespace zlog4net.Util.PatternStringConverters
{
    /// <summary>
    ...
    /// The value of the <see cref="zlog4net.Util.PatternConverter.Option"/> determines 
    /// the name of the variable to output. <see cref="zlog4net.Util.PatternConverter.Option"/>
    ...
    internal sealed class EnvironmentFolderPathPatternConverter : PatternConverter
    {
        ...
        /// using the <see cref="zlog4net.Util.PatternConverter.Option"/>
        /// property.
        /// </para>
        /// </remarks>
