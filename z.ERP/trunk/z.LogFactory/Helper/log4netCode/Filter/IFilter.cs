...
namespace zlog4net.Filter
{
	...
	/// event filtering. Note that <see cref="zlog4net.Repository.Hierarchy.Logger"/> and 
	/// <see cref="zlog4net.Appender.AppenderSkeleton"/>, the parent class of all standard
