...
using zlog4net.Core;
using zlog4net.Layout.Pattern;
using zlog4net.Util;
using zlog4net.Util.PatternStringConverters;
using AppDomainPatternConverter=zlog4net.Layout.Pattern.AppDomainPatternConverter;
using DatePatternConverter=zlog4net.Layout.Pattern.DatePatternConverter;
using IdentityPatternConverter=zlog4net.Layout.Pattern.IdentityPatternConverter;
using PropertyPatternConverter=zlog4net.Layout.Pattern.PropertyPatternConverter;
using UserNamePatternConverter=zlog4net.Layout.Pattern.UserNamePatternConverter;
using UtcDatePatternConverter=zlog4net.Layout.Pattern.UtcDatePatternConverter;

namespace zlog4net.Layout
{
	/// <summary>
	...
	/// 			assumed (<see cref="zlog4net.DateFormatter.Iso8601DateFormatter"/>).
	/// 			</para>
	/// 			<para>
	...
	/// 			<see cref="zlog4net.DateFormatter.AbsoluteTimeDateFormatter"/>, 
	/// 			<see cref="zlog4net.DateFormatter.DateTimeDateFormatter"/> and respectively 
	/// 			<see cref="zlog4net.DateFormatter.Iso8601DateFormatter"/>. For example, 
