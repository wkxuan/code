...
using zlog4net.ObjectRenderer;
using zlog4net.Core;
using zlog4net.Util;
using zlog4net.Plugin;

namespace zlog4net.Repository
{
	/// <summary>
	...
	public abstract class LoggerRepositorySkeleton : ILoggerRepository
	{
		...
		/// using the <see cref="zlog4net.LogManager.GetLogger(string)"/> method.
		/// </para>
		/// <para>
		...
		/// </para>
		/// </remarks>
		abstract public zlog4net.Appender.IAppender[] GetAppenders();
