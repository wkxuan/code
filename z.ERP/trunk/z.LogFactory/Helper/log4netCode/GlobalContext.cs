...
namespace zlog4net
{
	...
	/// be included in the output of log messages. The <see cref="zlog4net.Layout.PatternLayout"/>
	...
	public sealed class GlobalContext
	{
		...
		{
			Properties[zlog4net.Core.LoggingEvent.HostNameProperty] = SystemInfo.HostName;
		}
