...
namespace zlog4net.Core
{
	...
	public class LogImpl : LoggerWrapperImpl, ILog
	{
		...
		/// <see cref="zlog4net.ObjectRenderer.IObjectRenderer"/>. It then 
		...
		/// <summary>
		/// Event handler for the <see cref="zlog4net.Repository.ILoggerRepository.ConfigurationChanged"/> event
		/// </summary>
