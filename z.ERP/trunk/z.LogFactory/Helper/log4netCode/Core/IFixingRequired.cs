...
namespace zlog4net.Core
{
	...
	/// <see cref="zlog4net.Appender.IAppender.DoAppend"/> method.
	/// </para>
	/// <para>
	/// When objects that implement this interface are stored 
	/// in the context properties maps <see cref="zlog4net.GlobalContext"/>
	/// <see cref="zlog4net.GlobalContext.Properties"/> and <see cref="zlog4net.ThreadContext"/>
	/// <see cref="zlog4net.ThreadContext.Properties"/> are fixed 
