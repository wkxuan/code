...
namespace zlog4net.Core
{
	...
	/// </para>
	/// <para>
	/// This class is used by the wrapper managers (e.g. <see cref="zlog4net.LogManager"/>)
	...
	public sealed class LoggerManager
	{
		...
		static LoggerManager()
		{
			...
			{
				s_repositorySelector = new DefaultRepositorySelector(typeof(zlog4net.Repository.Hierarchy.Hierarchy));
			}
#endif
		}
		...
		/// <see cref="zlog4net.Repository.Hierarchy.Hierarchy"/> object.
		/// </para>
		/// <para>
