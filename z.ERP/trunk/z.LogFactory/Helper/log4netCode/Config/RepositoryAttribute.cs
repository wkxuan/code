...
namespace zlog4net.Config
{
	...
	/// specifies the type of the <see cref="zlog4net.Repository.ILoggerRepository"/> object 
	...
	public /*sealed*/ class RepositoryAttribute : Attribute
	{
		...
		/// The type must implement the <see cref="zlog4net.Repository.ILoggerRepository"/>
		/// interface.
		/// </para>
		/// <para>
