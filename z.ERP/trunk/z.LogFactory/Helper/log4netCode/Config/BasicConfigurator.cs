...
namespace zlog4net.Config
{
	...
	/// </para>
	/// <para>
	/// Appenders can also implement the <see cref="zlog4net.Core.IOptionHandler"/> interface. Therefore
	/// they would require that the <see cref="zlog4net.Core.IOptionHandler.ActivateOptions()"/> method
