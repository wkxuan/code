	...
	public class UdpAppender : AppenderSkeleton
	{
		...
		public int RemotePort
		{
			...
			set 
			{
				...
				{
					throw zlog4net.Util.SystemInfo.CreateArgumentOutOfRangeException("value", (object)value,
		...
		public override void ActivateOptions()
		{
			...
			{
				throw zlog4net.Util.SystemInfo.CreateArgumentOutOfRangeException("this.RemotePort", (object)RemotePort,
			...
			{
				throw zlog4net.Util.SystemInfo.CreateArgumentOutOfRangeException("this.LocalPort", (object)LocalPort,
