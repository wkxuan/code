...
namespace zlog4net.Appender
{
	...
	public class ColoredConsoleAppender : AppenderSkeleton
	{
		...
		/// <summary>
		/// This method is called by the <see cref="AppenderSkeleton.DoAppend(zlog4net.Core.LoggingEvent)"/> method.
		/// </summary>
        ...
        override protected void Append(zlog4net.Core.LoggingEvent loggingEvent) 
		{
