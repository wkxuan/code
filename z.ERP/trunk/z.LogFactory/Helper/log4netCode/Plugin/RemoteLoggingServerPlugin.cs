...
using zlog4net.Core;
using IRemoteLoggingSink = zlog4net.Appender.RemotingAppender.IRemoteLoggingSink;

namespace zlog4net.Plugin
{
	/// <summary>
	/// Plugin that listens for events from the <see cref="zlog4net.Appender.RemotingAppender"/>
	/// </summary>
	/// <remarks>
	/// <para>
	...
	/// a remote <see cref="zlog4net.Appender.RemotingAppender"/>.
	/// </para>
	/// <para>
