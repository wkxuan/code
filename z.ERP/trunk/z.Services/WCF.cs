...
{ 
    public class WCF
    {
        ...
        /// <returns></returns>
        public static T CreateWCFServiceByURL<T>(string url, string bing = "wsHttpBinding")
        {
            if (string.IsNullOrEmpty(url))
                throw new NotSupportedException("url不能为空");
        ...
        /// <returns></returns>
        static Binding CreateBinding(string binding)
        {
