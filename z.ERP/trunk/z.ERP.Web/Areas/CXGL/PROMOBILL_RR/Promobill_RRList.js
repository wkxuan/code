search.beforeVue = function () {
    ...
    search.screenParam.colDef = [
        ...
        {
            title: '操作', key: 'operate', authority: "110009", onClick: function (index, row, data) {
                _.OpenPage({
                    id: 11000900,
                    title: '随机立减活动定义单',
                    url: "CXGL/PROMOBILL_RR/Promobill_RREdit/" + row.BILLID
                });
            }
        }
    ];
...
search.newCondition = function () {
    search.searchParam.PROMOTYPE = 5;
...
search.addHref = function (row) {
    _.OpenPage({
        id: 11000901,
        title: '新增随机立减活动定义单',
        url: "CXGL/PROMOBILL_RR/Promobill_RREdit/"
    });
}
